...
test('trip planner creates a clearly unbooked itinerary suggestion',async({page})=>{
  ...
  await expect(page.getByText('Rough planning estimate')).toBeVisible();
  await expect(page.getByText(/€9,800.*€13,200/)).toBeVisible();
